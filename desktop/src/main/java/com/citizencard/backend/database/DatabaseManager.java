...
public class DatabaseManager {
    ...
    private String readSchema() {
        ...
        schema.append(
                "INSERT OR IGNORE INTO residents (id, card_id, full_name, date_of_birth, room_number, phone_number, email, id_number, balance, pin_hash, photo_path) VALUES (1, 'CARD001', 'Nguyễn Văn A', '1990-01-01', '101', '0901234567', 'nguyenvana@example.com', '001234567890', 0, '000000', NULL);");
