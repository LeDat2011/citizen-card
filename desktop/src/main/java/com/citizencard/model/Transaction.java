...
public class Transaction {
    ...
    private String transactionType; // TOPUP, PAYMENT, INVOICE
    private Integer amount;
    private Integer balanceBefore;
    private Integer balanceAfter;
    private String paymentStatus; // NULL, PENDING, PAID (chỉ cho INVOICE)
    private String serviceName; // Tên dịch vụ (cho INVOICE)
